# Generated by Django 4.2.4 on 2023-11-01 12:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creationdate', models.DateTimeField(auto_now_add=True)),
                ('donation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Auth.donor')),
            ],
        ),
        migrations.CreateModel(
            name='Donation',
            fields=[
                ...
                ('updationdate', models.DateField(null=True)),
                ('donationarea', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Auth.donationarea')),
                ('donor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Auth.donor')),
                ('volunteer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Auth.volunteer')),
            ],
        ),
    ]
